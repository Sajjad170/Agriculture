...
class GeminiApiService {
  // Your real API key added here
  final String _apiKey = 'AIzaSyDcLPr7FpipaBfAWneWJypR5ut0o-_R_yU';

  // Updated model endpoint (you can change to gemini-3 or flash)
